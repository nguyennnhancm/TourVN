 ...
 */
@Entity
@javax.persistence.Table(name = "contact_mech_type_purpose")
@javax.persistence.IdClass(ContactMechTypePurposePK.class)
public class ContactMechTypePurpose implements Serializable{
    private String contactMechTypeId;

    @Id
    @javax.persistence.Column(name = "CONTACT_MECH_TYPE_ID", nullable = false, insertable = true, updatable = true, length = 20)
    ...
    public boolean equals(Object o) {
        ...
        ContactMechTypePurpose that = (ContactMechTypePurpose) o;
